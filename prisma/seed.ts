...
await prisma.customer.createMany({data:[{code:'C001',name:'王老板',platform:'淘宝天猫店',level:'H高价值',ownerId:z.id},{code:'C002',name:'李老板',platform:'京东',level:'G成长型',ownerId:z.id},{code:'C003',name:'陈老板',platform:'淘宝C店',level:'M普通复购',ownerId:z.id}],skipDuplicates:true});
await prisma.taskRule.createMany({data:[{shift:'白班',taskType:'平台登录',startTime:'08:00',endTime:'08:30'},{shift:'白班',taskType:'昨日未成交电联',startTime:'08:30',endTime:'10:00'},{shift:'晚班',taskType:'抖音留资电联',startTime:'19:00',endTime:'22:00'}],skipDuplicates:true});
}
